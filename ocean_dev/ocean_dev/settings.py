...
EMAIL_DEFAULT_EMAIL = config('EMAIL_DEFAULT_EMAIL')
...
ON_BOARD_REMAINDER = "Complete on-boarding"
...
SME_SUPPLIER_ACTIVATED = "ACCOUNT_ACTIVATED"
...
# Docu sign constants
DOCU_SIGN_AUTH_URL = config('DOCU_SIGN_AUTH_URL')
DOCU_SIGN_AUTH_BASE_URL = config('DOCU_SIGN_AUTH_BASE_URL')  # demo
...
DOCU_SIGN_CLIENT_USER_ID = config('DOCU_SIGN_CLIENT_USER_ID')
# account id from account data
DOCU_SIGN_ACCOUNT_ID = config('DOCU_SIGN_ACCOUNT_ID')
DOCU_SIGN_HOST_URL = config('DOCU_SIGN_HOST_URL')
