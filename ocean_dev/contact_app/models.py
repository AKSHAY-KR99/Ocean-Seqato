...
(E_COMMERCE, "E_COMMERCE"), (MOBILE_APP, "MOBILE_APP"), (SAAS, "SAAS"), (SUBSCRIPTION, "SUBSCRIPTION"), (OTHER, "OTHER"))
...
def send_email_lead_save_signal(instance, **kwargs):
    ...
    """
    if instance.current_status == ON_BOARDING_CUSTOMER and not instance.is_mail_send:
